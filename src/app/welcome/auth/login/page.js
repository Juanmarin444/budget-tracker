...
import { PowerIcon, KeyIcon, AtSymbolIcon, ArrowUpRightIcon } from "@heroicons/react/24/outline";
    ...
    return (
        <div className="flex flex-col w-full sm:flex-row sm:w-11/12">
            <section className="flex justify-center flex-col bg-gradient-to-br from-slate-900 via-blue-950 via-25% to-gray-900 sm:w-1/2 text-slate-300 px-12 py-40">
                ...
                <Link href="/welcome/auth/signup" text="Sign up for free" className="flex flex-row text-gray-50 text-sm font-normal pt-4 hover:text-gray-400" >
