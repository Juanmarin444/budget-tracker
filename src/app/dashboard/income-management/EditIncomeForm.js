"use client"
import { CalendarDaysIcon, CurrencyDollarIcon, PlusCircleIcon, UserGroupIcon } from '@heroicons/react/24/outline';
import React, { useState, useEffect } from 'react';

export default function EditIncomeForm ({ income, updateIncome }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const updatedIncome = { ...income, source, amount: parseFloat(amount), date };
    ...
    return (
        <div className="block w-fit p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Income</h5>
