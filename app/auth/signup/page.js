    ...
    return (
        <div className="flex flex-col w-full sm:flex-row sm:w-11/12">
            <section className="flex justify-center flex-col bg-gradient-to-br from-slate-900 via-blue-950 via-25% to-gray-900 sm:w-1/2 text-slate-300 px-12 py-40">
                ...
                <Link href="/auth/login" text="Sign up for free" className="flex flex-row text-gray-50 text-sm font-normal pt-4 hover:text-gray-400" >
            ...
            <section className=" flex justify-center bg-gray-50 py-20 sm:w-1/2">
                <form className="space-y-3">
                    <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
                        <h1 className={`${nunitoSans.className} mb-3 text-2xl`}>Sign up for more savings.</h1>
                        ...
                        <div className="w-full">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <UserIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-blue-700" />
                                </div>
                            </div>
                            {/* Email Input */}
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <AtSymbolIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-blue-700" />
                                </div>
                            </div>
                            {/* Password Input */}
                            <div className="mt-4">
                                ...
                                <div className="relative">
                                    ...
                                    <KeyIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-blue-700" />
                                </div>
                            </div>
                        </div>
